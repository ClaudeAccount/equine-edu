...
window.COURSE_CONFIG = {
  ...
  modules: [
    ...
    { num: 5, title: 'Study Guide', type: 'Review', file: '6-study-guide.html', desc: 'Self-test with reveal prompts on color families, common mix-ups, and identification scenarios.' },
    {
      num:   6,
