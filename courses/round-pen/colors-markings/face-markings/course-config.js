...
window.COURSE_CONFIG = {
  ...
  modules: [
    ...
    { num: 6, title: 'Study Guide', type: 'Review', file: '7-study-guide.html', desc: 'Self-test with reveal prompts on marking names, combination markings, and description rules.' },
    {
      num:   7,
